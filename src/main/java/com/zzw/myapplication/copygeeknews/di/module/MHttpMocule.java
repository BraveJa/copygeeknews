...
import com.zzw.myapplication.copygeeknews.di.qulifier.MZhihuUrl;
import com.zzw.myapplication.copygeeknews.di.qulifier.MyUrl;
...
public class MHttpMocule {
	...
	Retrofit provideZhihuRetrofit(Retrofit.Builder builder, OkHttpClient client) {
		return createRetrofit(builder, client, MZhihuApis.HOST);
	}

	@Singleton
	@Provides
	MZhihuApis provideZhihuService(@MZhihuUrl Retrofit retrofit) {
		return retrofit.create(MZhihuApis.class);
	}
